...
function Expolore({Icone, text}: exploring) {
    return (
            <button className="w-[268px] h-[50px] mb-[10px] flex justify-start items-center rounded-[5px] hover:bg-[#00DAEA] xl:justify-center  2xl:justify-center 2xl:h-[100%] xl:rounded-none 2xl:rounded-none">
