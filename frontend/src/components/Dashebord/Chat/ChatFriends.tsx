                                                ...
                                                }
                                                {
                                                    searchfriend === "" && props.friendsloding ? (
                                                        props.ListFriends &&  props.ListFriends?.map((user: any, index: number) => (
                                                            <Friend_chat key={user.user_id} setListFriends={props.setListFriends} index={index} user={user} changecolor={friendClicked === index} setchangecolor={setFriendClicked} setchatloding={setchatloding} setonlyChat={setonlyChat} setfriendchat={setfriendchat}/>
