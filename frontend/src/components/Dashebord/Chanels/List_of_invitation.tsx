  ...
  return ( 
    <Modal onClose={onClose} isOpen={isOpen} isCentered>
        ...
        <ModalContent background={'#41424D'} height={'400px'}>
            <ModalHeader borderBottomWidth='1px' color={'white'} className="font-sora font-500">invitation list</ModalHeader>
            <ModalCloseButton color={'white'}/>
            <ModalBody flexDir={'column'}>
              <div className="w-[100%] h-[270px] test5 flex flex-col gap-1 rounded-[7px] overflow-y-auto">
                  {
                    invitationList && Array.isArray(invitationList) &&  invitationList?.map((user: any, index: number) => (
